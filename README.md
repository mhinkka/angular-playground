...
- [Protractor](https://github.com/angular/protractor): For e2e testing Angular applications.
...
###Grunt plugins (npms)
- [grunt-contrib-less](https://github.com/gruntjs/grunt-contrib-less): Compiles LESS files into CSS files. LESS is an extension to CSS.
